...
export const CATEGORY = ["Top", "Dress", "Pants","Man","Woman", "New","Sale","Accessory"];
...
export const PRODUCT_GET_NEW_REQUEST = "PRODUCT_GET_NEW_REQUEST";
export const PRODUCT_GET_NEW_SUCCESS = "PRODUCT_GET_NEW_SUCCESS";
export const PRODUCT_GET_NEW_FAIL = "PRODUCT_GET_NEW_FAIL";
export const PRODUCT_GET_SALE_REQUEST = "PRODUCT_GET_SALE_REQUEST";
export const PRODUCT_GET_SALE_SUCCESS = "PRODUCT_GET_SALE_SUCCESS";
export const PRODUCT_GET_SALE_FAIL = "PRODUCT_GET_SALE_FAIL";
